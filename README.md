...
Results-driven **Data Analyst** with **3+ years of experience** turning raw data into clear, actionable insights. I specialize in end-to-end data pipelines, interactive dashboards, and scalable cloud solutions.

- 🎓 Pursuing **MS in Computer Science** · University of Central Florida (UCF)
- 📊 Passionate about storytelling through data — dashboards that *explain*, not just display
- ☁️ Working across **AWS**, **Snowflake**, **Databricks**, and **Power BI**
- 🌱 Currently diving deeper into **ML for analytics** and **PySpark on Databricks**
- 🎯 Next goal: **AWS Data Engineer Associate**
